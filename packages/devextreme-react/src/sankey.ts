...
type ISankeyOptionsNarrowedEvents = {
  ...
  onLinkClick?: ((e: LinkClickEvent) => any);
  onNodeClick?: ((e: NodeClickEvent) => any);
}
...
type ILabelProps = React.PropsWithChildren<{
  ...
  customizeText?: ((itemInfo: dxSankeyNode) => any);
...
type ITooltipProps = React.PropsWithChildren<{
  ...
  customizeNodeTooltip?: ((info: { label: string, title: string, weightIn: number, weightOut: number }) => any);
  enabled?: boolean;
  font?: BaseWidgetTypes.Font;
  format?: LocalizationTypes.Format;
  linkTooltipTemplate?: ((info: { source: string, target: string, weight: number }, element: any) => any) | template;
  nodeTooltipTemplate?: ((info: { label: string, weightIn: number, weightOut: number }, element: any) => any) | template;
  opacity?: number;
