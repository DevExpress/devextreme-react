...
import type { dxDiagramCustomCommand, dxDiagramShape } from "devextreme/ui/diagram";
...
type IDiagramOptions = React.PropsWithChildren<Properties & IHtmlOptions & {
  ...
  defaultGridSize?: number | object;
  defaultPageSize?: object;
  defaultZoomLevel?: number | object;
  onGridSizeChange?: (value: number | object) => void;
  onPageSizeChange?: (value: object) => void;
  onZoomLevelChange?: (value: number | object) => void;
}>
...
type INodesProps = React.PropsWithChildren<{
  autoLayout?: object | "auto" | "off" | "tree" | "layered" | {
    orientation?: "horizontal" | "vertical";
    type?: "auto" | "off" | "tree" | "layered";
  };
