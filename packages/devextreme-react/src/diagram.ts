...
type IDiagramOptionsNarrowedEvents = {
  ...
  onItemDblClick?: ((e: ItemDblClickEvent) => any);
  onRequestEditOperation?: ((e: RequestEditOperationEvent) => any);
  onRequestLayoutUpdate?: ((e: RequestLayoutUpdateEvent) => any);
}
...
type ICustomShapeProps = React.PropsWithChildren<{
  ...
  minHeight?: number;
  minWidth?: number;
  template?: ((container: dxSVGElement, data: { item: dxDiagramShape }) => any) | template;
  ...
  textWidth?: number;
  title?: string;
  toolboxTemplate?: ((container: dxSVGElement, data: { item: dxDiagramShape }) => any) | template;
