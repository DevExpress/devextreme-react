...
type IListOptionsNarrowedEvents<TItem = any, TKey = any> = {
  onContentReady?: ((e: ContentReadyEvent<TItem, TKey>) => any);
  onDisposing?: ((e: DisposingEvent<TItem, TKey>) => any);
  onGroupRendered?: ((e: GroupRenderedEvent<TItem, TKey>) => any);
  onInitialized?: ((e: InitializedEvent<TItem, TKey>) => any);
  onItemClick?: ((e: ItemClickEvent<TItem, TKey>) => any);
  onItemContextMenu?: ((e: ItemContextMenuEvent<TItem, TKey>) => any);
  onItemDeleted?: ((e: ItemDeletedEvent<TItem, TKey>) => any);
  onItemDeleting?: ((e: ItemDeletingEvent<TItem, TKey>) => any);
  onItemHold?: ((e: ItemHoldEvent<TItem, TKey>) => any);
  onItemRendered?: ((e: ItemRenderedEvent<TItem, TKey>) => any);
  onItemReordered?: ((e: ItemReorderedEvent<TItem, TKey>) => any);
  onItemSwipe?: ((e: ItemSwipeEvent<TItem, TKey>) => any);
  onPageLoading?: ((e: PageLoadingEvent<TItem, TKey>) => any);
  onPullRefresh?: ((e: PullRefreshEvent<TItem, TKey>) => any);
  onScroll?: ((e: ScrollEvent<TItem, TKey>) => any);
  onSelectAllValueChanged?: ((e: SelectAllValueChangedEvent<TItem, TKey>) => any);
}
...
type IItemDraggingProps = React.PropsWithChildren<{
  ...
  dragTemplate?: ((dragInfo: { fromIndex: number, itemData: any, itemElement: any }, containerElement: any) => any) | template;
  ...
  onDisposing?: ((e: SortableDisposingEvent) => any);
  ...
  onInitialized?: ((e: SortableInitializedEvent) => any);
...
type IMenuItemProps = React.PropsWithChildren<{
  action?: ((itemElement: any, itemData: any) => any);
  text?: string;
}>
