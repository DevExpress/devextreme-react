...
type ISchedulerOptionsNarrowedEvents = {
  onAppointmentAdded?: ((e: AppointmentAddedEvent) => any);
  onAppointmentAdding?: ((e: AppointmentAddingEvent) => any);
  onAppointmentClick?: ((e: AppointmentClickEvent) => any);
  onAppointmentContextMenu?: ((e: AppointmentContextMenuEvent) => any);
  onAppointmentDblClick?: ((e: AppointmentDblClickEvent) => any);
  onAppointmentDeleted?: ((e: AppointmentDeletedEvent) => any);
  onAppointmentDeleting?: ((e: AppointmentDeletingEvent) => any);
  onAppointmentFormOpening?: ((e: AppointmentFormOpeningEvent) => any);
  onAppointmentRendered?: ((e: AppointmentRenderedEvent) => any);
  onAppointmentTooltipShowing?: ((e: AppointmentTooltipShowingEvent) => any);
  onAppointmentUpdated?: ((e: AppointmentUpdatedEvent) => any);
  onAppointmentUpdating?: ((e: AppointmentUpdatingEvent) => any);
  onCellClick?: ((e: CellClickEvent) => any);
  onCellContextMenu?: ((e: CellContextMenuEvent) => any);
...
type IAppointmentDraggingProps = React.PropsWithChildren<{
  ...
  data?: any;
  group?: string;
  onAdd?: ((e: { component: dxScheduler, event: event, fromComponent: dxSortable | dxDraggable, fromData: any, itemData: any, itemElement: any, toComponent: dxSortable | dxDraggable, toData: any }) => any);
  onDragEnd?: ((e: { cancel: boolean, component: dxScheduler, event: event, fromComponent: dxSortable | dxDraggable, fromData: any, itemData: any, itemElement: any, toComponent: dxSortable | dxDraggable, toData: any, toItemData: any }) => any);
  onDragMove?: ((e: { cancel: boolean, component: dxScheduler, event: event, fromComponent: dxSortable | dxDraggable, fromData: any, itemData: any, itemElement: any, toComponent: dxSortable | dxDraggable, toData: any }) => any);
  onDragStart?: ((e: { cancel: boolean, component: dxScheduler, event: event, fromData: any, itemData: any, itemElement: any }) => any);
  onRemove?: ((e: { component: dxScheduler, event: event, fromComponent: dxSortable | dxDraggable, fromData: any, itemData: any, itemElement: any, toComponent: dxSortable | dxDraggable }) => any);
...
type IResourceProps = React.PropsWithChildren<{
  ...
  displayExpr?: ((resource: any) => any) | string;
  fieldExpr?: string;
  label?: string;
  useColorAsDefault?: boolean;
  valueExpr?: (() => any) | string;
}>
...
type IViewProps = React.PropsWithChildren<{
  ...
  appointmentCollectorTemplate?: ((data: { appointmentCount: number, isCompact: boolean }, collectorElement: any) => any) | template;
  appointmentTemplate?: ((model: AppointmentTemplateData | { appointmentData: Record<string, any>, targetedAppointmentData: Record<string, any> }, itemIndex: number, contentElement: any) => any) | template;
  appointmentTooltipTemplate?: ((model: AppointmentTooltipTemplateData | { appointmentData: Record<string, any>, targetedAppointmentData: Record<string, any> }, itemIndex: number, contentElement: any) => any) | template;
  cellDuration?: number;
  dataCellTemplate?: ((itemData: any, itemIndex: number, itemElement: any) => any) | template;
  dateCellTemplate?: ((itemData: any, itemIndex: number, itemElement: any) => any) | template;
  dropDownAppointmentTemplate?: ((itemData: any, itemIndex: number, contentElement: any) => any) | template;
  endDayHour?: number;
  ...
  name?: string;
  resourceCellTemplate?: ((itemData: any, itemIndex: number, itemElement: any) => any) | template;
  scrolling?: dxSchedulerScrolling;
  startDate?: any | number | string;
  startDayHour?: number;
  timeCellTemplate?: ((itemData: any, itemIndex: number, itemElement: any) => any) | template;
