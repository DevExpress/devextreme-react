...
type ITreeViewOptionsNarrowedEvents<TKey = any> = {
  onContentReady?: ((e: ContentReadyEvent<TKey>) => any);
  onDisposing?: ((e: DisposingEvent<TKey>) => any);
  onInitialized?: ((e: InitializedEvent<TKey>) => any);
  onItemClick?: ((e: ItemClickEvent<TKey>) => any);
  onItemCollapsed?: ((e: ItemCollapsedEvent<TKey>) => any);
  onItemContextMenu?: ((e: ItemContextMenuEvent<TKey>) => any);
  onItemExpanded?: ((e: ItemExpandedEvent<TKey>) => any);
  onItemHold?: ((e: ItemHoldEvent<TKey>) => any);
  onItemRendered?: ((e: ItemRenderedEvent<TKey>) => any);
  onSelectAllValueChanged?: ((e: SelectAllValueChangedEvent<TKey>) => any);
}
