...
type IAnnotationProps = React.PropsWithChildren<{
  ...
  template?: ((annotation: dxPieChartCommonAnnotationConfig | any, element: any) => any) | template;
  text?: string;
  textOverflow?: "ellipsis" | "hide" | "none";
  tooltipEnabled?: boolean;
  tooltipTemplate?: ((annotation: dxPieChartAnnotationConfig | any, element: any) => any) | template;
...
type ILegendProps = React.PropsWithChildren<{
  ...
  customizeHint?: ((pointInfo: { pointColor: string, pointIndex: number, pointName: any }) => any);
  customizeItems?: ((items: Array<PieChartLegendItem>) => any);
  customizeText?: ((pointInfo: { pointColor: string, pointIndex: number, pointName: any }) => any);
  font?: BaseWidgetTypes.Font;
  ...
  markerSize?: number;
  markerTemplate?: ((legendItem: PieChartLegendItem, element: any) => any) | template;
