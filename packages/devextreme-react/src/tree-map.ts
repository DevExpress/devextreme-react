...
type ITooltipProps = React.PropsWithChildren<{
  ...
  contentTemplate?: ((info: { node: dxTreeMapNode, value: number, valueText: string }, element: any) => any) | template;
  cornerRadius?: number;
  customizeTooltip?: ((info: { node: dxTreeMapNode, value: number, valueText: string }) => any);
  enabled?: boolean;
  font?: ChartsFont;
