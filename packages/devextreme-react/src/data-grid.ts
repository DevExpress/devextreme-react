...
type IDataGridOptionsNarrowedEvents<TRowData = any, TKey = any> = {
  onAdaptiveDetailRowPreparing?: ((e: AdaptiveDetailRowPreparingEvent<TRowData, TKey>) => any);
  onCellClick?: ((e: CellClickEvent<TRowData, TKey>) => any);
  onCellDblClick?: ((e: CellDblClickEvent<TRowData, TKey>) => any);
  onCellPrepared?: ((e: CellPreparedEvent<TRowData, TKey>) => any);
  onContentReady?: ((e: ContentReadyEvent<TRowData, TKey>) => any);
  onContextMenuPreparing?: ((e: ContextMenuPreparingEvent<TRowData, TKey>) => any);
  onDataErrorOccurred?: ((e: DataErrorOccurredEvent<TRowData, TKey>) => any);
  onDisposing?: ((e: DisposingEvent<TRowData, TKey>) => any);
  onEditCanceled?: ((e: EditCanceledEvent<TRowData, TKey>) => any);
  onEditCanceling?: ((e: EditCancelingEvent<TRowData, TKey>) => any);
  onEditingStart?: ((e: EditingStartEvent<TRowData, TKey>) => any);
  onEditorPrepared?: ((e: EditorPreparedEvent<TRowData, TKey>) => any);
  onEditorPreparing?: ((e: EditorPreparingEvent<TRowData, TKey>) => any);
  onExporting?: ((e: ExportingEvent<TRowData, TKey>) => any);
  onFocusedCellChanging?: ((e: FocusedCellChangingEvent<TRowData, TKey>) => any);
  onFocusedRowChanging?: ((e: FocusedRowChangingEvent<TRowData, TKey>) => any);
  onInitialized?: ((e: InitializedEvent<TRowData, TKey>) => any);
  onInitNewRow?: ((e: InitNewRowEvent<TRowData, TKey>) => any);
  onKeyDown?: ((e: KeyDownEvent<TRowData, TKey>) => any);
  onRowClick?: ((e: RowClickEvent<TRowData, TKey>) => any);
  onRowCollapsed?: ((e: RowCollapsedEvent<TRowData, TKey>) => any);
  onRowCollapsing?: ((e: RowCollapsingEvent<TRowData, TKey>) => any);
  onRowDblClick?: ((e: RowDblClickEvent<TRowData, TKey>) => any);
  onRowExpanded?: ((e: RowExpandedEvent<TRowData, TKey>) => any);
  onRowExpanding?: ((e: RowExpandingEvent<TRowData, TKey>) => any);
  onRowInserted?: ((e: RowInsertedEvent<TRowData, TKey>) => any);
  onRowInserting?: ((e: RowInsertingEvent<TRowData, TKey>) => any);
  onRowPrepared?: ((e: RowPreparedEvent<TRowData, TKey>) => any);
  onRowRemoved?: ((e: RowRemovedEvent<TRowData, TKey>) => any);
  onRowRemoving?: ((e: RowRemovingEvent<TRowData, TKey>) => any);
  onRowUpdated?: ((e: RowUpdatedEvent<TRowData, TKey>) => any);
  onRowUpdating?: ((e: RowUpdatingEvent<TRowData, TKey>) => any);
  onRowValidating?: ((e: RowValidatingEvent<TRowData, TKey>) => any);
  onSaved?: ((e: SavedEvent<TRowData, TKey>) => any);
  onSaving?: ((e: SavingEvent<TRowData, TKey>) => any);
  onToolbarPreparing?: ((e: ToolbarPreparingEvent<TRowData, TKey>) => any);
}
...
type IButtonProps = React.PropsWithChildren<{
  cssClass?: string;
  disabled?: boolean | ((options: { column: dxDataGridColumn, component: dxDataGrid, row: dxDataGridRowObject }) => any);
  hint?: string;
  icon?: string;
  name?: "cancel" | "delete" | "edit" | "save" | "undelete";
  onClick?: ((e: ColumnButtonClickEvent) => any);
  template?: ((cellElement: any, cellInfo: { column: dxDataGridColumn, columnIndex: number, component: dxDataGrid, data: Record<string, any>, key: any, row: dxDataGridRowObject, rowIndex: number, rowType: string }) => any) | template;
  text?: string;
  visible?: boolean | ((options: { column: dxDataGridColumn, component: dxDataGrid, row: dxDataGridRowObject }) => any);
...
type IColumnProps = React.PropsWithChildren<{
  ...
  calculateFilterExpression?: ((filterValue: any, selectedFilterOperation: string | null, target: string) => any);
  calculateGroupValue?: ((rowData: any) => any) | string;
  calculateSortValue?: ((rowData: any) => any) | string;
  caption?: string;
  cellTemplate?: ((cellElement: any, cellInfo: { column: dxDataGridColumn, columnIndex: number, component: dxDataGrid, data: Record<string, any>, displayValue: any, oldValue: any, row: dxDataGridRowObject, rowIndex: number, rowType: string, text: string, value: any, watch: (() => any) }) => any) | template;
  columns?: Array<dxDataGridColumn | string>;
  cssClass?: string;
  customizeText?: ((cellInfo: { groupInterval: string | number, target: string, value: any, valueText: string }) => any);
  dataField?: string;
  dataType?: "string" | "number" | "date" | "boolean" | "object" | "datetime";
  editCellTemplate?: ((cellElement: any, cellInfo: { column: dxDataGridColumn, columnIndex: number, component: dxDataGrid, data: Record<string, any>, displayValue: any, row: dxDataGridRowObject, rowIndex: number, rowType: string, setValue(newValue, newText): any, text: string, value: any, watch: (() => any) }) => any) | template;
  editorOptions?: any;
  encodeHtml?: boolean;
  falseText?: string;
  ...
  headerFilter?: Record<string, any> | {
    ...
    dataSource?: Array<any> | DataSourceOptions | ((options: { component: Record<string, any>, dataSource: DataSourceOptions | null }) => any) | null | Store;
  ...
  lookup?: Record<string, any> | {
    ...
    calculateCellValue?: ((rowData: any) => any);
    dataSource?: Array<any> | DataSourceOptions | ((options: { data: Record<string, any>, key: any }) => any) | null | Store;
    displayExpr?: ((data: any) => any) | string;
    valueExpr?: string;
  };
  minWidth?: number;
  name?: string;
  ...
  sortIndex?: number;
  sortingMethod?: ((value1: any, value2: any) => any);
  sortOrder?: "asc" | "desc";
  trueText?: string;
...
type ICustomOperationProps = React.PropsWithChildren<{
  calculateFilterExpression?: ((filterValue: any, field: dxFilterBuilderField) => any);
  caption?: string;
  customizeText?: ((fieldInfo: { field: dxFilterBuilderField, value: string | number | any, valueText: string }) => any);
  dataTypes?: Array<"string" | "number" | "date" | "boolean" | "object" | "datetime">;
  editorTemplate?: ((conditionInfo: { field: dxFilterBuilderField, setValue: (() => any), value: string | number | any }, container: any) => any) | template;
  hasValue?: boolean;
  icon?: string;
  name?: string;
...
type IEditingProps = React.PropsWithChildren<{
  allowAdding?: boolean;
  allowDeleting?: boolean | ((options: { component: dxDataGrid, row: dxDataGridRowObject }) => any);
  allowUpdating?: boolean | ((options: { component: dxDataGrid, row: dxDataGridRowObject }) => any);
...
type IFieldProps = React.PropsWithChildren<{
  ...
  caption?: string;
  customizeText?: ((fieldInfo: { value: string | number | any, valueText: string }) => any);
  dataField?: string;
  dataType?: "string" | "number" | "date" | "boolean" | "object" | "datetime";
  editorOptions?: any;
  editorTemplate?: ((conditionInfo: { field: dxFilterBuilderField, filterOperation: string, setValue: (() => any), value: string | number | any }, container: any) => any) | template;
  falseText?: string;
...
type IFilterBuilderProps = React.PropsWithChildren<{
  ...
  onContentReady?: ((e: FilterBuilderContentReadyEvent) => any);
  onDisposing?: ((e: FilterBuilderDisposingEvent) => any);
  onEditorPrepared?: ((e: FilterBuilderEditorPreparedEvent) => any);
  onEditorPreparing?: ((e: FilterBuilderEditorPreparingEvent) => any);
  onInitialized?: ((e: FilterBuilderInitializedEvent) => any);
...
type IFilterPanelProps = React.PropsWithChildren<{
  customizeText?: ((e: { component: GridBase, filterValue: Record<string, any>, text: string }) => any);
...
type IFormProps = React.PropsWithChildren<{
  ...
  minColWidth?: number;
  onContentReady?: ((e: FormContentReadyEvent) => any);
  onDisposing?: ((e: FormDisposingEvent) => any);
  onEditorEnterKey?: ((e: EditorEnterKeyEvent) => any);
  onFieldDataChanged?: ((e: FieldDataChangedEvent) => any);
  onInitialized?: ((e: FormInitializedEvent) => any);
  onOptionChanged?: ((e: FormOptionChangedEvent) => any);
  optionalMark?: string;
  readOnly?: boolean;
  requiredMark?: string;
...
type IFormItemProps = React.PropsWithChildren<{
  ...
  label?: Record<string, any> | {
    ...
    showColon?: boolean;
    template?: ((itemData: { component: dxForm, dataField: string, editorOptions: any, editorType: string, name: string, text: string }, itemElement: any) => any) | template;
    text?: string;
    visible?: boolean;
  };
  name?: string;
  template?: ((data: { component: dxForm, dataField: string, editorOptions: Record<string, any>, editorType: string, name: string }, itemElement: any) => any) | template;
  validationRules?: Array<CommonTypes.ValidationRule>;
  visible?: boolean;
  visibleIndex?: number;
  render?: (...params: any) => React.ReactNode;
...
type IGroupItemProps = React.PropsWithChildren<{
  ...
  column?: string;
  customizeText?: ((itemInfo: { value: string | number | any, valueText: string }) => any);
...
type IMasterDetailProps = React.PropsWithChildren<{
  autoExpandAll?: boolean;
  enabled?: boolean;
  template?: ((detailElement: any, detailInfo: { data: Record<string, any>, key: any, watch: (() => any) }) => any) | template;
  render?: (...params: any) => React.ReactNode;
  component?: React.ComponentType<any>;
  keyFn?: (data: any) => string;
}>
...
type IRowDraggingProps = React.PropsWithChildren<{
  ...
  dragTemplate?: ((dragInfo: { itemData: any, itemElement: any }, containerElement: any) => any) | template;
  dropFeedbackMode?: "push" | "indicate";
  filter?: string;
  group?: string;
  handle?: string;
  onAdd?: ((e: { component: GridBase, dropInsideItem: boolean, event: event, fromComponent: dxSortable | dxDraggable, fromData: any, fromIndex: number, itemData: any, itemElement: any, toComponent: dxSortable | dxDraggable, toData: any, toIndex: number }) => any);
  onDragChange?: ((e: { cancel: boolean, component: GridBase, dropInsideItem: boolean, event: event, fromComponent: dxSortable | dxDraggable, fromData: any, fromIndex: number, itemData: any, itemElement: any, toComponent: dxSortable | dxDraggable, toData: any, toIndex: number }) => any);
  onDragEnd?: ((e: { cancel: boolean, component: GridBase, dropInsideItem: boolean, event: event, fromComponent: dxSortable | dxDraggable, fromData: any, fromIndex: number, itemData: any, itemElement: any, toComponent: dxSortable | dxDraggable, toData: any, toIndex: number }) => any);
  onDragMove?: ((e: { cancel: boolean, component: GridBase, dropInsideItem: boolean, event: event, fromComponent: dxSortable | dxDraggable, fromData: any, fromIndex: number, itemData: any, itemElement: any, toComponent: dxSortable | dxDraggable, toData: any, toIndex: number }) => any);
  onDragStart?: ((e: { cancel: boolean, component: GridBase, event: event, fromData: any, fromIndex: number, itemData: any, itemElement: any }) => any);
  onRemove?: ((e: { component: GridBase, event: event, fromComponent: dxSortable | dxDraggable, fromData: any, fromIndex: number, itemData: any, itemElement: any, toComponent: dxSortable | dxDraggable, toData: any, toIndex: number }) => any);
  onReorder?: ((e: { component: GridBase, dropInsideItem: boolean, event: event, fromComponent: dxSortable | dxDraggable, fromData: any, fromIndex: number, itemData: any, itemElement: any, promise: any, toComponent: dxSortable | dxDraggable, toData: any, toIndex: number }) => any);
...
type ISummaryProps = React.PropsWithChildren<{
  calculateCustomSummary?: ((options: { component: dxDataGrid, groupIndex: number, name: string, summaryProcess: string, totalValue: any, value: any }) => any);
