...
type ITreeListOptionsNarrowedEvents<TRowData = any, TKey = any> = {
  ...
  onNodesInitialized?: ((e: NodesInitializedEvent<TRowData, TKey>) => any);
...
type IButtonProps = React.PropsWithChildren<{
  cssClass?: string;
  disabled?: boolean | ((options: { column: dxTreeListColumn, component: dxTreeList, row: dxTreeListRowObject }) => any);
  hint?: string;
  icon?: string;
  name?: "add" | "cancel" | "delete" | "edit" | "save" | "undelete";
  onClick?: ((e: { column: dxTreeListColumn, component: dxTreeList, element: any, event: event, model: any, row: dxTreeListRowObject }) => any);
  template?: ((cellElement: any, cellInfo: { column: dxTreeListColumn, columnIndex: number, component: dxTreeList, data: Record<string, any>, key: any, row: dxTreeListRowObject, rowIndex: number, rowType: string }) => any) | template;
  text?: string;
  visible?: boolean | ((options: { column: dxTreeListColumn, component: dxTreeList, row: dxTreeListRowObject }) => any);
...
type IColumnProps = React.PropsWithChildren<{
  ...
  caption?: string;
  cellTemplate?: ((cellElement: any, cellInfo: { column: dxTreeListColumn, columnIndex: number, component: dxTreeList, data: Record<string, any>, displayValue: any, oldValue: any, row: dxTreeListRowObject, rowIndex: number, rowType: string, text: string, value: any, watch: (() => any) }) => any) | template;
  ...
  editCellTemplate?: ((cellElement: any, cellInfo: { column: dxTreeListColumn, columnIndex: number, component: dxTreeList, data: Record<string, any>, displayValue: any, row: dxTreeListRowObject, rowIndex: number, rowType: string, setValue(newValue, newText): any, text: string, value: any, watch: (() => any) }) => any) | template;
  editorOptions?: any;
  encodeHtml?: boolean;
  falseText?: string;
...
type IEditingProps = React.PropsWithChildren<{
  allowAdding?: boolean | ((options: { component: dxTreeList, row: dxTreeListRowObject }) => any);
  allowDeleting?: boolean | ((options: { component: dxTreeList, row: dxTreeListRowObject }) => any);
  allowUpdating?: boolean | ((options: { component: dxTreeList, row: dxTreeListRowObject }) => any);
