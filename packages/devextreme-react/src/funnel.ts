...
type ILabelProps = React.PropsWithChildren<{
  ...
  customizeText?: ((itemInfo: { item: dxFunnelItem, percent: number, percentText: string, value: number, valueText: string }) => any);
  font?: BaseWidgetTypes.Font;
...
type ILegendProps = React.PropsWithChildren<{
  ...
  customizeHint?: ((itemInfo: { item: dxFunnelItem, text: string }) => any);
  customizeItems?: ((items: Array<FunnelLegendItem>) => any);
  customizeText?: ((itemInfo: { item: dxFunnelItem, text: string }) => any);
  font?: BaseWidgetTypes.Font;
  horizontalAlignment?: "center" | "left" | "right";
  ...
  markerSize?: number;
  markerTemplate?: ((legendItem: FunnelLegendItem, element: any) => any) | template;
...
type ITooltipProps = React.PropsWithChildren<{
  ...
  contentTemplate?: ((info: { item: dxFunnelItem, percent: number, percentText: string, value: number, valueText: string }, element: any) => any) | template;
  cornerRadius?: number;
  customizeTooltip?: ((info: { item: dxFunnelItem, percent: number, percentText: string, value: number, valueText: string }) => any);
  enabled?: boolean;
  font?: BaseWidgetTypes.Font;
  format?: LocalizationTypes.Format;
  opacity?: number;
