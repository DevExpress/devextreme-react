...
type ILookupOptionsNarrowedEvents = {
  ...
  onPageLoading?: ((e: PageLoadingEvent) => any);
  onPullRefresh?: ((e: PullRefreshEvent) => any);
  onScroll?: ((e: ScrollEvent) => any);
...
type IDropDownOptionsProps = React.PropsWithChildren<{
  ...
  onContentReady?: ((e: PopoverContentReadyEvent) => any);
  onDisposing?: ((e: PopoverDisposingEvent) => any);
  onHidden?: ((e: HiddenEvent) => any);
  onHiding?: ((e: HidingEvent) => any);
  onInitialized?: ((e: PopoverInitializedEvent) => any);
  onOptionChanged?: ((e: OptionChangedEvent) => any);
  onShowing?: ((e: ShowingEvent) => any);
  onShown?: ((e: ShownEvent) => any);
