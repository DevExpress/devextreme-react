...
class LinearGauge extends BaseComponent<React.PropsWithChildren<ILinearGaugeOptions>> {

  public get instance(): dxLinearGauge {
    return this._instance;
  }

  protected _WidgetClass = dxLinearGauge;
...
type ILabelProps = React.PropsWithChildren<{
  customizeText?: ((scaleValue: { value: number, valueText: string }) => any);
...
type ISubvalueIndicatorProps = React.PropsWithChildren<{
  ...
  text?: Record<string, any> | {
    customizeText?: ((indicatedValue: { value: number, valueText: string }) => any);
    font?: BaseWidgetTypes.Font;
    format?: LocalizationTypes.Format;
    indent?: number;
  };
...
type ITooltipProps = React.PropsWithChildren<{
  ...
  contentTemplate?: ((scaleValue: { value: number, valueText: string }, element: any) => any) | template;
  cornerRadius?: number;
