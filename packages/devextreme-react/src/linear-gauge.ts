...
type ILinearGaugeOptions = React.PropsWithChildren<Properties & IHtmlOptions & {
...
type ITooltipProps = React.PropsWithChildren<{
  ...
  contentTemplate?: ((scaleValue: { value: number, valueText: string }, element: any) => string) | template;
  cornerRadius?: number;
  customizeTooltip?: ((scaleValue: { value: number, valueText: string }) => object);
  enabled?: boolean;
  font?: BaseWidgetTypes.Font;
  format?: LocalizationTypes.Format;
  interactive?: boolean;
