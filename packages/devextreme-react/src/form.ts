...
type IGroupItemProps = React.PropsWithChildren<{
  ...
  itemType?: "empty" | "group" | "simple" | "tabbed" | "button";
  name?: string;
  template?: ((data: { component: dxForm, formData: Record<string, any> }, itemElement: any) => any) | template;
  visible?: boolean;
  visibleIndex?: number;
  render?: (...params: any) => React.ReactNode;
  component?: React.ComponentType<any>;
...
type ITabPanelOptionsProps = React.PropsWithChildren<{
  ...
  itemTemplate?: ((itemData: any, itemIndex: number, itemElement: any) => any) | template;
  itemTitleTemplate?: ((itemData: any, itemIndex: number, itemElement: any) => any) | template;
  loop?: boolean;
  noDataText?: string;
  onContentReady?: ((e: TabPanelContentReadyEvent) => any);
  onDisposing?: ((e: TabPanelDisposingEvent) => any);
  onInitialized?: ((e: TabPanelInitializedEvent) => any);
  onItemClick?: ((e: ItemClickEvent) => any);
  onItemContextMenu?: ((e: ItemContextMenuEvent) => any);
  onItemHold?: ((e: ItemHoldEvent) => any);
  onItemRendered?: ((e: ItemRenderedEvent) => any);
  onOptionChanged?: ((e: TabPanelOptionChangedEvent) => any);
  onSelectionChanged?: ((e: SelectionChangedEvent) => any);
  onTitleClick?: ((e: TitleClickEvent) => any);
  onTitleHold?: ((e: TitleHoldEvent) => any);
  onTitleRendered?: ((e: TitleRenderedEvent) => any);
