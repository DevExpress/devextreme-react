...
type IContextMenuOptionsNarrowedEvents<TKey = any> = {
  ...
  onHidden?: ((e: HiddenEvent<TKey>) => any);
  onHiding?: ((e: HidingEvent<TKey>) => any);
  ...
  onPositioning?: ((e: PositioningEvent<TKey>) => any);
  onShowing?: ((e: ShowingEvent<TKey>) => any);
  onShown?: ((e: ShownEvent<TKey>) => any);
}
