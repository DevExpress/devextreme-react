...
type IBarGaugeOptions = React.PropsWithChildren<Properties & IHtmlOptions & {
...
type ILegendProps = React.PropsWithChildren<{
  ...
  markerSize?: number;
  markerTemplate?: ((legendItem: BarGaugeLegendItem, element: any) => string) | template;
...
type ITooltipProps = React.PropsWithChildren<{
  ...
  contentTemplate?: ((scaleValue: { index: number, value: number, valueText: string }, element: any) => string) | template;
  cornerRadius?: number;
  customizeTooltip?: ((scaleValue: { index: number, value: number, valueText: string }) => object);
  enabled?: boolean;
  font?: BaseWidgetTypes.Font;
  format?: LocalizationTypes.Format;
  interactive?: boolean;
