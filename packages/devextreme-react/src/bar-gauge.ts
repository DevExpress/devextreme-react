...
type ILabelProps = React.PropsWithChildren<{
  ...
  customizeText?: ((barValue: { value: number, valueText: string }) => any);
  font?: BaseWidgetTypes.Font;
...
type ILegendProps = React.PropsWithChildren<{
  ...
  customizeHint?: ((arg: { item: BarGaugeBarInfo, text: string }) => any);
  customizeItems?: ((items: Array<BarGaugeLegendItem>) => any);
  customizeText?: ((arg: { item: BarGaugeBarInfo, text: string }) => any);
  font?: BaseWidgetTypes.Font;
  horizontalAlignment?: "center" | "left" | "right";
  ...
  markerSize?: number;
  markerTemplate?: ((legendItem: BarGaugeLegendItem, element: any) => any) | template;
...
type ITooltipProps = React.PropsWithChildren<{
  ...
  contentTemplate?: ((scaleValue: { index: number, value: number, valueText: string }, element: any) => any) | template;
  cornerRadius?: number;
  customizeTooltip?: ((scaleValue: { index: number, value: number, valueText: string }) => any);
  enabled?: boolean;
  font?: BaseWidgetTypes.Font;
  format?: LocalizationTypes.Format;
  interactive?: boolean;
