...
type IFileUploaderOptionsProps = React.PropsWithChildren<{
  ...
  multiple?: boolean;
  name?: string;
  onBeforeSend?: ((e: BeforeSendEvent) => any);
  onContentReady?: ((e: FileUploaderContentReadyEvent) => any);
  onDisposing?: ((e: FileUploaderDisposingEvent) => any);
  onDropZoneEnter?: ((e: DropZoneEnterEvent) => any);
  onDropZoneLeave?: ((e: DropZoneLeaveEvent) => any);
  onFilesUploaded?: ((e: FilesUploadedEvent) => any);
  onInitialized?: ((e: FileUploaderInitializedEvent) => any);
  onOptionChanged?: ((e: OptionChangedEvent) => any);
  onProgress?: ((e: ProgressEvent) => any);
  onUploadAborted?: ((e: UploadAbortedEvent) => any);
  onUploaded?: ((e: UploadedEvent) => any);
  onUploadError?: ((e: UploadErrorEvent) => any);
  onUploadStarted?: ((e: UploadStartedEvent) => any);
  onValueChanged?: ((e: FileUploaderValueChangedEvent) => any);
  progress?: number;
  readOnly?: boolean;
  ...
  uploadFile?: ((file: any, progressCallback: (() => any)) => any);
  uploadHeaders?: any;
...
type IMentionProps = React.PropsWithChildren<{
  ...
  displayExpr?: ((item: any) => any) | string;
  itemTemplate?: ((itemData: any, itemIndex: number, itemElement: any) => any) | template;
  marker?: string;
  minSearchLength?: number;
  searchExpr?: Array<(() => any) | string> | (() => any) | string;
  searchTimeout?: number;
  template?: ((mentionData: { id: string | number, marker: string, value: any }, contentElement: any) => any) | template;
