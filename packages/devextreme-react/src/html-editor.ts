...
type IFileUploaderOptionsProps = React.PropsWithChildren<{
  ...
  multiple?: boolean;
  name?: string;
  onBeforeSend?: ((e: { component: dxFileUploader, element: any, file: any, model: any, request: any, uploadInfo: UploadInfo }) => void);
  ...
  onUploadAborted?: ((e: { component: dxFileUploader, element: any, event: event, file: any, message: string, model: any, request: any }) => void);
  onUploaded?: ((e: { component: dxFileUploader, element: any, event: event, file: any, message: string, model: any, request: any }) => void);
  onUploadError?: ((e: { component: dxFileUploader, element: any, error: any, event: event, file: any, message: string, model: any, request: any }) => void);
  onUploadStarted?: ((e: { component: dxFileUploader, element: any, event: event, file: any, model: any, request: any }) => void);
  onValueChanged?: ((e: { component: dxFileUploader, element: any, event: event, model: any, previousValue: Array<any>, value: Array<any> }) => void);
  progress?: number;
  readOnly?: boolean;
...
type IMentionProps = React.PropsWithChildren<{
  ...
  displayExpr?: ((item: object) => string) | string;
