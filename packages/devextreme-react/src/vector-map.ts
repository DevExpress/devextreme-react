...
type IAnnotationProps = React.PropsWithChildren<{
  ...
  template?: ((annotation: dxVectorMapAnnotationConfig | any, element: any) => any) | template;
  text?: string;
  textOverflow?: "ellipsis" | "hide" | "none";
  tooltipEnabled?: boolean;
  tooltipTemplate?: ((annotation: dxVectorMapAnnotationConfig | any, element: any) => any) | template;
...
type ILegendProps = React.PropsWithChildren<{
  ...
  customizeHint?: ((itemInfo: { color: string, end: number, index: number, size: number, start: number }) => any);
  customizeItems?: ((items: Array<VectorMapLegendItem>) => any);
  customizeText?: ((itemInfo: { color: string, end: number, index: number, size: number, start: number }) => any);
  font?: BaseWidgetTypes.Font;
  horizontalAlignment?: "center" | "left" | "right";
  ...
  markerSize?: number;
  markerTemplate?: ((legendItem: VectorMapLegendItem, element: any) => any) | template;
...
type IProjectionProps = React.PropsWithChildren<{
  aspectRatio?: number;
  from?: ((coordinates: Array<number>) => any);
  to?: ((coordinates: Array<number>) => any);
}>
...
type ITooltipProps = React.PropsWithChildren<{
  ...
  contentTemplate?: ((info: MapLayerElement, element: any) => any) | template;
  cornerRadius?: number;
