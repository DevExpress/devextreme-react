...
type IMenuOptionsNarrowedEvents<TKey = any> = {
  ...
  onSubmenuHidden?: ((e: SubmenuHiddenEvent<TKey>) => any);
  onSubmenuHiding?: ((e: SubmenuHidingEvent<TKey>) => any);
  onSubmenuShowing?: ((e: SubmenuShowingEvent<TKey>) => any);
  onSubmenuShown?: ((e: SubmenuShownEvent<TKey>) => any);
}
