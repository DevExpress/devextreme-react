...
interface ICLASS_NAMEOptions extends IOptions, IHtmlOptions {
  optionRender?: (props: any, index?: number) => React.ReactNode;
...
interface ICLASS_NAMEOptions extends IOptions, IHtmlOptions {
  ...
  optionComponent?: React.ComponentType<any>;
  optionKeyFn?: (data: any) => string;
  anotherOptionRender?: (props: any, index?: number) => React.ReactNode;
...
interface ICLASS_NAMEOptions extends IOptions, IHtmlOptions {
  render?: (props: any, index?: number) => React.ReactNode;
